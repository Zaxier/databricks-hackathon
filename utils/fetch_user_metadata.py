...
# MAGIC %scala
# MAGIC spark.conf.set("com.databricks.training.module_name", "sapn_hackathon")
...
# MAGIC   spark.conf.set("com.databricks.training.spark.userEmail", username)
# MAGIC }
...
user_name = spark.conf.get("com.databricks.training.spark.userName").replace('.', '_')
user_email = spark.conf.get("com.databricks.training.spark.userEmail")
